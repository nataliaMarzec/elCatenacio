...
//si hay usuario muestra esto sino muestra el login
    return (
      <React.Fragment >
...
{/* 
          ...
          <UncontrolledDropdown nav direction="down">
            <DropdownToggle nav>
              <img src={'../../assets/img/avatars/3.jpg'} className="img-avatar" alt="natimarzec708@gmail.com" />
            </DropdownToggle>
            ...
            <DropdownMenu right>
              ...
              <DropdownItem><i className="fa fa-wrench"></i>Configurar perfil</DropdownItem>
